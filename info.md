...
Для того, что бы начать работу с удаленным репозиторием, нам нужно получить ссылку на него либо создать репозиторий самим на своем аккаунте в GitHub, а так же можно использовать команду  fork в GitHub и создать себе копию того репозитория, с которым нужно работать.

Скопировав ссылку на репозиторий, переходим в Git bush  или в VS code  и вводим команду: 
git clone и вставяем ссылку на репозиторий, например:

>git clone https://github.com/Olga/homework_pull_request.git
